(function (argument) {
	var table = [
				"https://s2.loli.net/2023/04/16/ocEYmi1MqwkCsGL.png",
				 "Hydrogen", 
				 "湖南 长沙", 
				 "大三", 
				 "清华大学",
			...
			function init() {
				...
				document.getElementById( 'metamind-members-container' ).appendChild( renderer.domElement );
			 ...
			 // document.addEventListener( 'mousemove', onDocumentMouseMove, false );
				var oDiv=document.getElementById('metamind-members-container');
